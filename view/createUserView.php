...
<div class="container white_div my-5 mx-auto p-4 shadow-lg rounded">
  ...
  <form class="pb-5 m-auto" action="index.php?action=createUser" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="email" name="email" placeholder="Votre mail" class="form-control" id="email"
    ...
    <div class="mb-3">
      ...
      <div id="passwordHelpBlock" class="form-text">
        Votre pseudo doit comporter entre 5 et 25 caractères. Utilisez des majuscules, des minuscules et des numéros
        afin de sécuriser votre mot de passe.
      </div>
    </div>
