      ...
      <div class="row justify-content-right">
        ...
        <div class="col d-flex justify-content-end">
          <div class="social-media">
            <p class="mb-0 d-flex">
              <a href="mailto:contact@jeanforteroche.com" id="email_header"
                 class="d-flex align-items-center justify-content-center"><span class="fas fa-envelope"><i
                    class="sr-only">Email</i></span></a>
              <a href="#" class="d-flex align-items-center justify-content-center"><span class="fab fa-facebook-f"><i
                    class="sr-only">Facebook</i></span></a>
              <a href="#" class="d-flex align-items-center justify-content-center"><span class="fab fa-twitter"><i
                    class="sr-only">Twitter</i></span></a>
              <a href="#" class="d-flex align-items-center justify-content-center"><span class="fab fa-instagram"><i
                    class="sr-only">Instagram</i></span></a>
              <a href="#" class="d-flex align-items-center justify-content-center"><span class="fab fa-dribbble"><i
      ...
      <div class="collapse navbar-collapse order-last user" id="ftco-nav">
        <ul class="navbar-nav m-auto">
          <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle align-items-center justify-content-center"><span
                class="fas fa-user"><i class="sr-only">Utilisateur</i></span></a>
        ...
        <ul class="navbar-nav m-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown04">
              ...
              <a class="dropdown-item" href="index.php?action=post&id=4">Chapitre 3 : Un bel horizon, un nouveau
                regard</a>
