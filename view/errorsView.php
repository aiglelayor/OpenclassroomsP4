...
<html lang="fr">
	...
	<body class="d-flex flex-column min-vh-100">
		...
		<div class="white_div my-5 mx-auto p-4 text-center shadow-lg rounded">
			<h1 class="m-0 text-danger">Oups, il semble y avoir une erreur.</h1>
			<div><?php echo $errors; ?></div>
			<a href="index.php"><button type="button" class="btn btn-primary">Revenir à l'accueil</button></a>
			<img src="https://media.giphy.com/media/fV1yHo8YyoKjzvMCKr/giphy.gif" class="gif my-4" alt="Welcome Back !">
		</div>
