...
<html lang="fr">
	...
	<body class="d-flex flex-column min-vh-100">
		...
		<div class="white_div my-5 mx-auto p-4 text-center shadow-lg rounded">
			<h1 class="m-0">Votre compte a bien été créé !</h1>
			<p>Ravis de vous compter parmi nos lecteurs ! </br>Cliquez ci-dessous pour vous connecter.</p>
			<a href="index.php?action=login"><button type="button" class="btn btn-primary">Se connecter</button></a>
			<img src="https://media.giphy.com/media/g9582DNuQppxC/giphy.gif" class="gif my-4" alt="Welcome Back !">
		</div>
