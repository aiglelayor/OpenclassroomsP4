...
<div class="container white_div my-5 mx-auto p-4 shadow-lg rounded">
  ...
  <form class="pb-5 m-auto" action="index.php?action=userLogin" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="pseudoconnect" placeholder="Pseudo" class="form-control" id="pseudo"
             value="<?php if (isset($pseudoconnect)) {
               echo $pseudoconnect;
             } ?>">
    ...
    <div class="mb-3">
      ...
      <input type="password" name="passconnect" class="form-control" id="passconnect" placeholder="Mot de passe"
             aria-describedby="passwordHelpBlock">
      <div id="passwordHelpBlock" class="form-text">
        Si vous avez oublié votre mot de passe veuillez en demander un autre à l'adresse mail suivrante : <a
          href="mailto:contact@jeanforteroche.com">admin@forteroche.fr</a>.
      </div>
    </div>
